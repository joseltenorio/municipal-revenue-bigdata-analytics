...
def load_mef_income_config() -> dict[str, Any]:
    """Carga la configuración de la fuente MEF income."""
...
def get_candidate_resources(source_config: dict[str, Any]) -> dict[str, Any]:
    """Obtiene recursos candidatos definidos para MEF income."""

    resources = source_config.get("candidate_resources", {})

    if not resources:
        raise IngestionError(
            "No existen candidate_resources para mef_income en config/sources.yaml."
        )
...
def validate_resource(resource_key: str, resource: dict[str, Any]) -> None:
    ...
    if resource["format"] != "csv":
        raise IngestionError(
            ...
            "Este script de MEF income solo descarga recursos CSV."
        )
...
def main() -> None:
    ...
    try:
        ...
        print("=" * 80)
        print("Iniciando ingesta MEF income hacia Landing")
        ...
        print("=" * 80)
        print("Proceso MEF income fallido")
