"""Discovery de la fuente MEF de presupuesto y ejecución de ingresos.

Este script no implementa la ingesta final. Su objetivo es validar si la fuente
pública responde, qué tipo de contenido entrega y qué señales técnicas se pueden
registrar antes de diseñar la descarga definitiva.
"""
...
DEFAULT_URLS = [
    ...
    "https://fs.datosabiertos.mef.gob.pe/datastorefiles/2012-Ingreso.csv",
    "https://fs.datosabiertos.mef.gob.pe/datastorefiles/2026-Ingreso-Diario.csv",
    "https://fs.datosabiertos.mef.gob.pe/datastorefiles/Ingresos_Diccionario.csv",
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Ejecuta discovery liviano sobre la fuente MEF de ingresos."
    )
    parser.add_argument(
        "--url",
        action="append",
