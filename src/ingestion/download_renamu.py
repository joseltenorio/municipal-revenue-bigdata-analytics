"""Discovery de la fuente RENAMU 2022.

Este script valida acceso inicial a recursos candidatos de RENAMU. No descarga
bases completas ni extrae archivos definitivos en Landing.
"""
...
DEFAULT_URLS = [
    ...
    "https://www.inei.gob.pe/media/DATOS_ABIERTOS/RENAMU/DATA/2022.zip",
    "https://www.inei.gob.pe/media/DATOS_ABIERTOS/RENAMU/DICCIONARIO/2022/Diccionario.pdf",
    "https://www.datosabiertos.gob.pe/sites/default/files/BD_Muestra_2022_0.xlsx",
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Ejecuta discovery liviano sobre la fuente RENAMU 2022."
    )
    parser.add_argument(
        "--url",
        action="append",
